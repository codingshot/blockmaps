...
const CityInfoPanel = ({ city, onLocationClick }: CityInfoPanelProps) => {
  return (
    <div 
      ...
      className="bg-white/95 backdrop-blur-md rounded-xl shadow-xl border border-white/20 p-4 w-64 sm:w-72 cursor-pointer hover:bg-white/100 transition-all duration-200 hover:shadow-2xl z-50 relative"
    >
      {/* City Header */}
